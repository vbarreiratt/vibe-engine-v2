...
**[Cluster 3]** (Força: 0.66, Estabilidade: 1.00, Densidade: 0.73)
- **Cadeia de Formação**:
  - Sinais Recorrentes: Estado=38%, Matéria=88%, Movimento=25%
  - Sinais Dominantes: informativo / plástico / deslizar
- **Interpretação**: Cluster STRONG (66%). Vibe forte. Recorrência multi-camada (63%) e densidade alta.

**[Cluster 4]** (Força: 0.64, Estabilidade: 1.00, Densidade: 0.75)
- **Cadeia de Formação**:
  - Sinais Recorrentes: Estado=30%, Matéria=50%, Movimento=70%
  - Sinais Dominantes: energético / luz neon / pulsar
- **Interpretação**: Cluster STRONG (64%). Vibe forte. Recorrência multi-camada (60%) e densidade alta.
...
**[Cluster 10]** (Força: 0.94, Estabilidade: 0.50, Densidade: 0.81)
- **Cadeia de Formação**:
...
**[Cluster 11]** (Força: 0.93, Estabilidade: 0.20, Densidade: 0.76)
- **Cadeia de Formação**:
...
**[Cluster 13]** (Força: 0.74, Estabilidade: 0.20, Densidade: 0.70)
- **Cadeia de Formação**:
...
**[Cluster 1]** (Força: 0.51, Estabilidade: 1.00, Densidade: 0.74)
- **Cadeia de Formação**:
  - Sinais Recorrentes: Estado=33%, Matéria=33%, Movimento=50%
  - Sinais Dominantes: intenso / tinta vibrante / saltar
- **Interpretação**: Cluster WEAK (51%). Vibe fraca. Sinais dispersos (Recorrência < 60%). Requer curadoria.

**[Cluster 14]** (Força: 0.63, Estabilidade: 1.00, Densidade: 0.74)
- **Cadeia de Formação**:
  - Sinais Recorrentes: Estado=67%, Matéria=50%, Movimento=50%
  - Sinais Dominantes: caótico / papel / sobrepor
- **Interpretação**: Cluster WEAK (63%). Vibe fraca. Sinais dispersos (Recorrência < 60%). Requer curadoria.
...
**[Cluster 12]** (Força: 0.70, Estabilidade: 0.00, Densidade: 0.00)
- **Cadeia de Formação**:
  - Sinais Recorrentes: Estado=100%, Matéria=100%, Movimento=100%
