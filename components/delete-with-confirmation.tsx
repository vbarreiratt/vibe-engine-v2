...
interface DeleteWithConfirmationProps {
    onDelete: () => Promise<{ error?: string } | undefined | void>
    title?: string
...
export function DeleteWithConfirmation({
    ...
    description,
    warning,
    triggerClassName = "p-2 text-zinc-500 hover:text-red-500 hover:bg-red-500/10 rounded-full transition-colors"
    ...
    const handleDelete = async (e: React.MouseEvent) => {
        ...
        try {
            ...
            // If result has error, show it. If void or undefined/success, we assume success.
            // Adjust based on expected return type.
    ...
    return (
        <div className="relative" ref={modalRef} onClick={(e) => e.stopPropagation()}>
            ...
            {showConfirm && (
                <div className="absolute right-0 top-full mt-2 w-72 bg-zinc-900 border border-white/10 rounded-xl shadow-2xl z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 cursor-default">
